...
/**
 * @description Timeout for connecton to CoinGecko API in milliseconds (default: 60 seconds)
 * @kind constant
 */
const TIMEOUT = 60000

/**
 * @description Various options to limit the total requests at a given time
 * @kind constant
 */

const LIMIT = {
  BATCH_TOTAL: 100,
  BATCH_REFRESH_AMOUNT: 100,
  BATCH_REFRESH_INTERVAL: 60000,
  CONCURRENT_REQUESTS: 1,
  TIME_BETWEEN_REQUESTS: 1000 / REQUESTS_PER_SECOND
}
